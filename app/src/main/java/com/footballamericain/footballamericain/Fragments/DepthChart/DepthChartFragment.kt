...
class DepthChartFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        return inflater!!.inflate(R.layout.fragment_depth_chart, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment DepthChartFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): DepthChartFragment {
